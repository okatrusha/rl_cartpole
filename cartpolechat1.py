...
def train():
    ...
    # env = TimeLimit(gym.make("CartPole-v1"), max_episode_steps=1000)
    ...
    batch_size = 64
    gamma = 0.99
    # epsilon_start, epsilon_end, epsilon_decay = 1.0, 0.01, 150
    epsilon_start, epsilon_end, epsilon_decay = 1.0, 0.03, 0.999
    steps_done = 0
    ...
    for episode in range(1, 500):
        ...
        if total_reward >= 3000:
            ...
            torch.save(policy_net.state_dict(), "cartpole_best_model.pth")
            # break
